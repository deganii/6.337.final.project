...
class JacobianExternalOptimizerInterface(object):
  ...
  def __init__(self, loss, jacobian, var_list=None, equalities=None, inequalities=None,
               **optimizer_kwargs):
  ...
  def minimize(self, session=None, feed_dict=None, fetches=None,
    ...
    jacobian_func = self._make_eval_func(
        self._jacobian,
        session, feed_dict, fetches, loss_callback)
